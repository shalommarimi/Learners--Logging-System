...
namespace Logging_System.Models
{
    public class Reset
    {
        ...
        [MaxLength(13)]
        [MinLength(13)]
        [Display(Name = "RSA Identity Number")]
        ...
        public string ResetPassword(Reset _lean)
        {
            ...
            cmd.CommandText = "UPDATE [Learners_Information] SET [Password] = '" + randomPassword + "' WHERE [RSAID] = '" + _lean.RSAID + "' ";
